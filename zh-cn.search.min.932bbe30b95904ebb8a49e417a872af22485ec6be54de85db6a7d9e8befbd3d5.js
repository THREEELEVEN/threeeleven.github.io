...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh-cn.search-data.min.5f7e9db171fcfd9653c0f90dc2fd20009875cb9c72f135a0e01fda07a471f115.js',function(){input.required=false;search();});}
